...
from etl_package.transformations.delta_per_hour_metrics import compute_per_hour_deltas
...
@dlt.table(
    ...
    comment="Current music metadata snapshot (materialized view style).",
    table_properties={"quality": "silver"},
)
...
dlt.create_streaming_table(
    ...
    comment="SCD Type 2 history table for music metadata.",
    table_properties={"quality": "silver"},
)
